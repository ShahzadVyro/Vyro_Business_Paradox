  ...
  return (
    <div className="space-y-6 rounded-4xl border border-slate-200 bg-white p-8 shadow-2xl shadow-slate-200/60">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Edit Submission · {submission.Submission_ID}</p>
          <h1 className="text-3xl font-semibold text-slate-900">{steps[step].title}</h1>
          <p className="text-sm text-slate-500">Update submission information.</p>
        </div>
